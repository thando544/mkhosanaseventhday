...
export class Navbar extends Component {
  ...
  <nav className='flex items-center justify-between h-23 p-9 shadow-md'>
    <a href="" className='flex items-center justify-center text-2xl font-bold '><img src="/images/logo.png" alt="logo" />MASS</a>
 ...
 <div class="relative w-full max-w-sm">
  ...
  <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
    ...
    <li><a className='list-none text-2xl' href=""><HiOutlineBell /></a></li>
    </ul>
    
    <button  className='bg-blue-600 text-white h-8 w-29 cursor-pointer' id='navBtn'>Enroll</button>
